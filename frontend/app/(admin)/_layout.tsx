...
export default function AdminLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle: s.tabBar, tabBarShowLabel: false }}>
      <Tabs.Screen name="dashboard" options={{ tabBarIcon: ({ focused }) => <TabIcon Icon={LayoutDashboard} label="Bosh" focused={focused} /> }} />
      ...
      <Tabs.Screen name="workers" options={{ tabBarIcon: ({ focused }) => <TabIcon Icon={Wrench} label="Ishchi" focused={focused} /> }} />
